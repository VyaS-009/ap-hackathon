<<<<<<< HEAD:frontend/src/components/dashboard/task-allocation.tsx
import { UserCheck, MapPin, Clock } from "lucide-react";
=======
import { UserCheck, MapPin, Clock } from 'lucide-react';
import { Link } from 'react-router-dom'; // Assuming React Router is used
>>>>>>> 2f7ac261a7592b967e039499ff5ed36d8c4bf4de:frontend/src/components/dashboard/task-allocation-list.tsx
                        ...
                        <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h3 className="font-medium text-gray-900">{task.officer}</h3>
                                        <p className="text-sm text-gray-600">{task.task}</p>
                                    </div>
                                </div>
